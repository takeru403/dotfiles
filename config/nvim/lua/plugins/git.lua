...
return {
	...
	-- Git の変更をガターに表示
	{
		...
		opts = {
			...
			word_diff = true,
			linehl = true, -- 追加/変更された場合に行全体の背景色がつく
			numhl = true,
				...
				keymaps = {
					...
					view = {
						...
						{ "n", "]F", actions.select_last_entry, { desc = "最後のファイルの差分を開く" } },
						{
							...
							{ desc = "前のタブページでファイルを開く" },
						},
						{
							"n",
							"<C-w><C-f>",
							actions.goto_file_split,
							{ desc = "新しいスプリットでファイルを開く" },
						},
						{
							"n",
							"<C-w>gf",
							actions.goto_file_tab,
							{ desc = "新しいタブページでファイルを開く" },
						},
						{
							"n",
							"<leader>e",
							actions.focus_files,
							{ desc = "ファイルパネルにフォーカスを移動する" },
						},
						{
							"n",
							"<leader>b",
						...
						},
						{
							...
							{ desc = "利用可能なレイアウトを切り替える" },
						},
						{
							"n",
							"[x",
							actions.prev_conflict,
							{ desc = "マージツール: 前のコンフリクトにジャンプする" },
						},
						{
							"n",
							"]x",
							actions.next_conflict,
							{ desc = "マージツール: 次のコンフリクトにジャンプする" },
						},
						{
							"n",
							"<leader>co",
							actions.conflict_choose("ours"),
							{ desc = "コンフリクトの OURS バージョンを選択する" },
						},
						{
							"n",
							"<leader>ct",
							actions.conflict_choose("theirs"),
							{ desc = "コンフリクトの THEIRS バージョンを選択する" },
						},
						{
							"n",
							"<leader>cb",
							actions.conflict_choose("base"),
							{ desc = "コンフリクトの BASE バージョンを選択する" },
						},
						{
							"n",
							"<leader>ca",
							actions.conflict_choose("all"),
							{ desc = "コンフリクトのすべてのバージョンを選択する" },
						},
						{
							"n",
							"dx",
						...
						},
						{
							...
							{
								desc = "ファイル全体のコンフリクトに対して OURS バージョンを選択する",
							},
						},
						{
							"n",
							...
							{
								desc = "ファイル全体のコンフリクトに対して THEIRS バージョンを選択する",
							},
						},
						{
							"n",
							...
							{
								desc = "ファイル全体のコンフリクトに対して BASE バージョンを選択する",
							},
						},
						{
							"n",
							...
							{
								desc = "ファイル全体のコンフリクトに対してすべてのバージョンを選択する",
							},
						},
						{
							"n",
					...
					diff3 = {
						-- 3ウェイ diff レイアウトのマッピング
						{
							...
							{ desc = "ファイルの OURS バージョンから diff hunk を取得する" },
						},
						{
							{ "n", "x" },
							"3do",
							actions.diffget("theirs"),
							{ desc = "ファイルの THEIRS バージョンから diff hunk を取得する" },
						},
					...
					diff4 = {
						-- 4ウェイ diff レイアウトのマッピング
						{
							...
							{ desc = "ファイルの BASE バージョンから diff hunk を取得する" },
						},
						{
							{ "n", "x" },
							"2do",
					...
					file_panel = {
						...
						{ "n", "i", actions.listing_style, { desc = "'list' と 'tree' ビューを切り替える" } },
						{
							...
							{ desc = "ツリー表示でサブディレクトリをフラット化する" },
						},
						{
							"n",
							"R",
							actions.refresh_files,
							{ desc = "ファイルリストの統計とエントリを更新する" },
						},
						{
							"n",
							"<leader>e",
					...
					file_history_panel = {
						{ "n", "g!", actions.options, { desc = "オプションパネルを開く" } },
						{
							...
							{ desc = "カーソル下のエントリを diffview で開く" },
						},
						{
							"n",
							"y",
							actions.copy_hash,
							{ desc = "カーソル下のエントリのコミットハッシュをコピーする" },
						},
